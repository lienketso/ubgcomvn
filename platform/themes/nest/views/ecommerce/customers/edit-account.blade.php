            ...
            {!! Form::open(['route' => 'customer.edit-account']) !!}
                <div class="row">
                    ...
                    <div class="form-group col-md-12 @if ($errors->has('affiliation_id')) has-error @endif">
                        ...
                        <input type="text" class="form-control square" name="affiliation_id" id="affiliation_id" placeholder="Nhập mã giới thiệu" value="{{ old('affiliation_id', base64_decode(Request::get('aff_id'))) }}">
