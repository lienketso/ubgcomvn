<div class="footer-link-widget widget-install-app col  wow animate__animated animate__fadeInUp"  data-wow-delay=".5s">
    ...
    <div class="certificate">
        CÔNG TY CỔ PHẦN ĐẦU TƯ QUỐC TẾ UBG. <br>
        MSDN: 0315864765 <br> Do Phòng Đăng Ký Kinh Doanh - Sở kế hoạch Đầu tư <br>Thành phố Hồ Chí Minh cấp thay đổi lần 4 ngày 08/06/2021
        <br>
        <a href="https://online.gov.vn/Home/WebDetails/83390">
            <img src="https://ubgmart.com/storage/general/dkbct.png" style="max-width: 200px; margin-top: 15px; width: 100%"/>
        </a>
    </div>
