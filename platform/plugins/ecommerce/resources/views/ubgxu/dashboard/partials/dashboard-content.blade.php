    ...
    <div class="col-lg-3">
        <div class="card card-body mb-4">
            <article class="icontext">
                ...
                <div class="text">
                    <h6 class="mb-1 card-title">Số xu khả dụng</h6>
                    <span>{{ number_format($balance) }} xu</span>
                </div>
            </article>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="card card-body mb-4">
            <article class="icontext">
                ...
                <div class="text">
                    <h6 class="mb-1 card-title">Số xu đợi hoàn</h6>
                    <span>{{ number_format($totalCashBackPending) }} xu</span>
                </div>
            </article>
        </div>
    </div>
            ...
            <div class="col-12">
                ...
                <div class="alert alert-info" role="alert">
                    <h4 class="alert-heading">
                        ...
                        Bạn chưa chưa có xu ! Hãy mua sắm để nhận được xu nhé
                    </h4>
                    <hr>
                </div>
            </div>
