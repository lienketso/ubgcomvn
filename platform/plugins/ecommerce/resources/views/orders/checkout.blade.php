                                    ...
                                    <div class="ubgxu-checkout-content">
                                        <div class="ubgxu-checkout-title">
                                            <div class="custome-checkbox">
                                                ...
                                                <label for="remember-checkbox" class="form-check-label"><span>Thanh toán trước bằng UBGxu</span></label>
                                            </div>
                                        </div>
                                        <div class="ubgxu-checkout-avaiable">
                                            <p>Số xu khả dụng:
                                                @if ($payWithUbgXu)
                                                    ...
                                                    @endphp
                                                    <b>{{number_format($xu)}} xu</b>
                                                @else
                                                    <b>{{number_format(auth('customer')->user()->ubgxu)}} xu</b>
                                                @endif
                                            </p>
                                        </div>
                                    </div>
