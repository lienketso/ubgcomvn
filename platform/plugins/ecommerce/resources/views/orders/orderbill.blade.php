                            ...
                            <div class="order-bill-form">
                                <form action="" method="post" role="form" id="order-bill-form">
                                    ...
                                    <div id="customer_info">
                                        ...
                                        <p>Số xu khả dụng: <span id="customer_xu"></span> xu</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="">Khách hàng sử dụng xu để thanh toán hóa đơn: </label>
                                        <select name="pay_by_ubgxu" class="form-control" id="pay_by_ubgxu">
                                            <option selected value="0">Không sử dụng</option>
                                            <option value="1">Sử dụng xu để thanh toán</option>
                                        </select>
                                    </div>

                                    <div class="form-group" id="cashback_type_form">
                                        <label for="">Hình thức hoàn xu: </label>
                                        <select name="cashback_type" class="form-control">
                                            <option selected value="{{\Botble\Ecommerce\Enums\OrderCashbackTypeEnum::SLOW}}">Hoàn xu từng ngày</option>
                                            <option value="{{\Botble\Ecommerce\Enums\OrderCashbackTypeEnum::FAST}}">Hoàn xu 1 lần</option>
                                        </select>
                                    </div>
